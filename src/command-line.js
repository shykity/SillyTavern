...
export class CommandLineParser {
    ...
    parse(args) {
        ...
        const result = {
            configPath: configPath,
            dataRoot: dataRoot,
            port: cliArguments.port ?? (process.env.PORT ? parseInt(process.env.PORT, 10) : null) ?? getConfigValue('port', defaultConfig.port, 'number'),
            listen: cliArguments.listen ?? (process.env.PORT ? true : null) ?? getConfigValue('listen', defaultConfig.listen, 'boolean'),
            ...
            whitelistMode: cliArguments.whitelist ?? (process.env.PORT ? false : null) ?? getConfigValue('whitelistMode', defaultConfig.whitelistMode, 'boolean'),
